...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{ asset('admin/rekening/proses_edit') }}" enctype="multipart/form-data" method="post"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="atas_nama" class="form-control" placeholder="Atas Nama"
                        value="<?php echo $rekening->atas_nama ?>" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="number" name="urutan" class="form-control" placeholder="Urutan"
                        value="<?php echo $rekening->urutan ?>" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="file" name="gambar" class="form-control" placeholder="Gambar"
                        value="<?php echo $rekening->gambar ?>">
                    <small class="text-gray">Logo:
                        <br><img src="{{ asset('public/upload/image/thumbs/'.$rekening->gambar) }}"
                            style="width: 80px height: auto;" class="img img-thumbnail">
                    </small>
                </div>
            </div>
