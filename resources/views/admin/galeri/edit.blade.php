...
<div class="card shadow mb-4">
    <div class="card-body">
        ...
        <form action="{{ asset('admin/galeri/edit_proses') }}" method="post" enctype="multipart/form-data"
            ...
            <div class="row form-group">
                ...
                <div class="col-md-3">
                    <select name="status_text" class="form-control">
                        ...
                        <option value="Tidak" <?php if($galeri->status_text=="Tidak") { echo "selected"; } ?>>Tidak,
                            jangan tampilkan teks</option>
                    </select>
                ...
                <div class="col-md-3">
                    <select name="jenis_galeri" class="form-control">
                        ...
                        <option value="Testimonial"
                            <?php if($galeri->jenis_galeri=="Testimonial") { echo "selected"; } ?>>Background
                            Testimonial</option>
                    </select>
