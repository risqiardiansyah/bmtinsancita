	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{ asset('admin/team/tambahteam') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                {{ csrf_field() }}
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
                        <input type="file" name="foto" class="form-control" id="file" placeholder="Upload Foto" value="{{ old('gambar') }}">
