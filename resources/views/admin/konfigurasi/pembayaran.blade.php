...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{ asset('admin/konfigurasi/proses_pembayaran') }}" enctype="multipart/form-data" method="post"
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="judul_pembayaran" class="form-control"
                            value="<?php echo $site->judul_pembayaran ?>">
                    </div>

                    <div class="form-group">
                        <label>Informasi Lengkap Pembayaran</label>
                        <textarea name="isi_pembayaran"
                            class="form-control konten"><?php echo $site->isi_pembayaran ?></textarea>
                    </div>
